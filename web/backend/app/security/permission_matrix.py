...
PERMISSION_DEFINITIONS = {
    ...
    "stock.create": {"module": "stock", "action": "create", "description": "Créer des mouvements de stock"},
    ...
    "quote.delete": {"module": "quote", "action": "delete", "description": "Supprimer des devis"},
