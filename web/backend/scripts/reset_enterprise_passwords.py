...
# Mot de passe des comptes entreprise : jamais en clair dans le script
# (P0 #70 / A3) — variable d'environnement obligatoire.
PASSWORD = os.getenv('SEED_USER_PASSWORD')
if not PASSWORD:
    raise SystemExit(
        "ERREUR : SEED_USER_PASSWORD est absent.\n"
        "  - definir .env (voir .env.example),\n"
        "  - ou exporter SEED_USER_PASSWORD dans le shell."
    )
...
ENTERPRISE_USERS = [
    {
        ...
        'user': {'username': 'tech', 'email': 'tech@erp.com', 'password': PASSWORD, 'nom': 'Ramanantoandro', 'prenom': 'Thomas', 'telephone': '+261 34 12 345 67', 'role': Role.ADMIN, 'statut': StatutUtilisateur.ACTIF},
    ...
    },
    {
        ...
        'user': {'username': 'green', 'email': 'green@erp.com', 'password': PASSWORD, 'nom': 'Razafindramanana', 'prenom': 'Sophie', 'telephone': '+261 34 98 765 32', 'role': Role.MANAGER, 'statut': StatutUtilisateur.ACTIF},
    ...
    },
    {
        ...
        'user': {'username': 'distri', 'email': 'distri@erp.com', 'password': PASSWORD, 'nom': 'Rasoamanarivo', 'prenom': 'Lucas', 'telephone': '+261 34 45 678 91', 'role': Role.ADMIN, 'statut': StatutUtilisateur.ACTIF},
    ...
    },
    {
        ...
        'user': {'username': 'global', 'email': 'global@erp.com', 'password': PASSWORD, 'nom': 'Andriamiranto', 'prenom': 'Emma', 'telephone': '+261 34 56 789 01', 'role': Role.SALES, 'statut': StatutUtilisateur.ACTIF},
    ...
    },
    {
        ...
        'user': {'username': 'mega', 'email': 'mega@erp.com', 'password': PASSWORD, 'nom': 'Ramiaramanana', 'prenom': 'Hugo', 'telephone': '+261 34 67 890 12', 'role': Role.STOCK, 'statut': StatutUtilisateur.ACTIF},
