...
ENTERPRISE_USERS = [
    {
        ...
        'user': {'username': 'tech', 'email': 'tech@erp.com', 'password': os.getenv('SEED_USER_PASSWORD') or 'TechPass123!', 'nom': 'Ramanantoandro', 'prenom': 'Thomas', 'telephone': '+261 34 12 345 67', 'role': Role.ADMIN, 'statut': StatutUtilisateur.ACTIF},
    ...
    },
    {
        ...
        'user': {'username': 'green', 'email': 'green@erp.com', 'password': os.getenv('SEED_USER_PASSWORD') or 'GreenPass123!', 'nom': 'Razafindramanana', 'prenom': 'Sophie', 'telephone': '+261 34 98 765 32', 'role': Role.MANAGER, 'statut': StatutUtilisateur.ACTIF},
    ...
    },
    {
        ...
        'user': {'username': 'distri', 'email': 'distri@erp.com', 'password': os.getenv('SEED_USER_PASSWORD') or 'DistriPass123!', 'nom': 'Rasoamanarivo', 'prenom': 'Lucas', 'telephone': '+261 34 45 678 91', 'role': Role.ADMIN, 'statut': StatutUtilisateur.ACTIF},
    ...
    },
    {
        ...
        'user': {'username': 'global', 'email': 'global@erp.com', 'password': os.getenv('SEED_USER_PASSWORD') or 'GlobalPass123!', 'nom': 'Andriamiranto', 'prenom': 'Emma', 'telephone': '+261 34 56 789 01', 'role': Role.SALES, 'statut': StatutUtilisateur.ACTIF},
    ...
    },
    {
        ...
        'user': {'username': 'mega', 'email': 'mega@erp.com', 'password': os.getenv('SEED_USER_PASSWORD') or 'MegaPass123!', 'nom': 'Ramiaramanana', 'prenom': 'Hugo', 'telephone': '+261 34 67 890 12', 'role': Role.STOCK, 'statut': StatutUtilisateur.ACTIF},
