...
class TestTenantLimitGratuit:
    ...
    def test_create_second_gratuit_tenant_refused(self, app):
        client = app.test_client()
        _make_super_admin()
        headers = _login(client, 'super', 'Super123!')
        ...
        assert 'Limite de tenants atteinte' in r2.get_json()['message']
...
class TestTenantLimitStarter:
    ...
    def test_create_second_starter_tenant_refused(self, app):
        client = app.test_client()
        _make_super_admin()
        headers = _login(client, 'super', 'Super123!')
...
class TestTenantLimitPro:
    ...
    def test_create_third_pro_tenant_refused(self, app):
        client = app.test_client()
        _make_super_admin()
        headers = _login(client, 'super', 'Super123!')
        ...
        assert 'Limite de tenants atteinte' in r3.get_json()['message']
...
class TestTenantLimitEnterprise:
    ...
    def test_create_sixth_enterprise_tenant_refused(self, app):
        client = app.test_client()
        _make_super_admin()
        headers = _login(client, 'super', 'Super123!')
        ...
        assert r6.status_code == 403, r6.get_json()
        assert 'Limite de tenants atteinte' in r6.get_json()['message']
...
class TestCompanyRegistrationTenantLimit:
    def test_company_registration_respects_gratuit_limit(self, app):
        client = app.test_client()
...
class TestTenantLimitHelpers:
    def test_get_tenant_limit(self):
        ...
        assert get_tenant_limit('pro') == 2
        assert get_tenant_limit('enterprise') == 5
