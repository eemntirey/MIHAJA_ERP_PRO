...
const Clients = () => {
  ...
  const getClientTypeBadge = (type) => {
    const types = {
      ...
      association: { label: 'Association', class: 'warning' },
      collectivite: { label: 'Collectivité', class: 'info' },
      grossiste: { label: 'Grossiste', class: 'success' },
      distributeur: { label: 'Distributeur', class: 'success' },
      centrale_achat: { label: 'Centrale d\'achat', class: 'warning' },
    };
    return types[type] || { label: type, class: 'info' };
  };
      ...
      <div className="card filter-card">
        <div className="filter-controls">
          ...
          >
            ...
            <option value="centrale_achat">Centrale d'achat</option>
          </select>
        </div>
      </div>
