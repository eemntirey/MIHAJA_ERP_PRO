---
description: Étape 0 — Audit et intégration du compte Livreur dans MIHAJA_ERP_PRO
agent: code
---
...
web/backend/app/models/role.py / permission.py / role_permission.py (si présents)
