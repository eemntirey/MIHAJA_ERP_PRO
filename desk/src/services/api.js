...
// ======================================================
// PAPI PAYMENTS (outils de paiement : espèces, virement,
// chèque, MVola, Orange Money, Airtel Money)
// ======================================================
...
export const papiService = {
  ...
  getPayments: (params) => api.get('/papi/payments', { params }),
  getPayment: (id) => api.get(`/papi/payments/${id}`),
};
