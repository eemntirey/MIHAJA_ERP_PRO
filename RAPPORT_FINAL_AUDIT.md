...
**Cause** : Présence de valeurs secrètes par défaut (`<REDACTED_SECRET_KEY>`, `<REDACTED_JWT_SECRET_KEY>`, `<REDACTED_REDIS_PASSWORD>`, `CHANGE_ME_IN_PRODUCTION`) et mot de passe de seed en dur (`Test1234!`).
**Correction** :
